...
public class Spiller {
    ...
    public Spiller(Brukergrensesnitt spiller, Sted start, String valgnavn){ //konstruktoer
        grensesnitt = spiller; //hvilket grensesnitt man skal bruke
        lokasjon = start;
        navn = valgnavn;
    }

    public String hentnavn(){ //henter navn
        return navn;
    }

    public int hentFormue(){ //henter formue
        return formue;
    }

    public String sluttsum(){ //viser hvor mye spiller tjente
        String status = "\nSpillet er over, " + hentnavn() + " tjente " + formue + " kroner.\n";
        return status;
    }
