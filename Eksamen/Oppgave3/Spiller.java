...
public class Spiller {
    ...
    public Spiller(Sted start, Brukergrensesnitt spiller){ //konstruktoer
        lokasjon = start; //hvor man starter
    ...
    public int nyTrekk(){ //nytrekk metode
        ...
        valg = grensesnitt.beOmKommando(spoersmal, alternativer); //grensesnittet beomkommando blir brukt, og det man velger blir om til valg
            if (valg == 0){ //hvis man velger aa legge fra seg noe
                ...
                lokasjon = lokasjon.gaaVidere(); //lagrer neste sted i lokasjon
                System.out.println(lokasjon.posisjon); //printer ut hvor de er naa
            }
